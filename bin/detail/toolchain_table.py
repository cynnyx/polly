...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-nocodesign-10-2-arm64', 'Xcode', ios_version='10.2', nocodesign=True),
      Toolchain('ios-nocodesign-10-2-armv7', 'Xcode', ios_version='10.2', nocodesign=True),
      Toolchain('ios-nocodesign-10-2-wo-armv7s', 'Xcode', ios_version='10.2', nocodesign=True),
